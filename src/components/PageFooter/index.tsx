        ...
        <Flex>
          <RowBaseFlex>
            ...
            <Itemdiv>
              ...
              <Spacer height="10px" />
              <StyledLi href="https://soy-finance.gitbook.io/soy-finance/miscellaneous/media-kit" target="_blank">
                {t('Media Kit')}
              </StyledLi>
              <Spacer height="10px" />
              ...
              <Spacer height="10px" />
              <StyledLi href="https://bullsinvesting.club/" target="_blank">
                {t('BUSDT Stablecoin')}
              </StyledLi>
            </Itemdiv>
            <Itemdiv>
              ...
              <Spacer height="10px" />
              <StyledLi href="https://callistoenterprise.com/team" target="_blank">
                {t('Team')}
              </StyledLi>
              <Spacer height="10px" />
              <StyledLi href="https://github.com/SoyFinance/" target="_blank">
                {t('Github')}
              </StyledLi>
              <Spacer height="10px" />
              <StyledLi href="https://callisto.network/" target="_blank">
                {t('Callisto Network')}
              </StyledLi>
              <Spacer height="10px" />
              <StyledLi href="https://callistoenterprise.com/" target="_blank">
          ...
          <RowBaseFlex>
            <Itemdiv2>
              ...
              <Spacer height="10px" />
              <StyledLi href="https://clo.click/SOY-Deck" target="_blank">
                {t('Investor Deck')}
              </StyledLi>
              <Spacer height="10px" />
              <StyledLi
            ...
            <Itemdiv>
              {/* <Text align="center"><b>{t('Social Media')}</b></Text>
                            <Spacer height="10px" /> */}
              <Row>
                <StyledLi2 href="https://t.me/Soy_Finance" target="_blank">
                  <Telegram />
                </StyledLi2>
                <StyledLi2 href="https://twitter.com/Soy_Finance" target="_blank">
                  <Twitter />
                </StyledLi2>
                <StyledLi2 href="https://www.reddit.com/r/Soy_Finance/" target="_blank">
                  <Redit />
                </StyledLi2>
                <StyledLi2 href="https://www.facebook.com/Soy.Finance" target="_blank">
                  <Facebook />
                </StyledLi2>
              ...
              <Row3>
                <StyledLi2 href="https://coinmarketcap.com/currencies/soy-finance/" target="_blank">
                  <img src={Assets.CMCIcon} width="38px" height="38px" alt="CoinMarketCap" title="CoinMarketCap" />
                </StyledLi2>
                <StyledLi2 href="https://www.coingecko.com/en/coins/soy-finance" target="_blank">
                  <img src={Assets.coingecko} width="38px" height="38px" alt="Coingecko" title="Coingecko" />
                </StyledLi2>
                <StyledLi2 href="https://coinpaprika.com/coin/soy-soy-finance/" target="_blank">
                  <img src={Assets.coinpap} width="40px" height="40px" alt="Coinpaprika" title="Coinpaprika" />
                </StyledLi2>
          ...
          <RightsdivMob>
            <Spacer height="30px" />
            <Text>
              {t('All rights reserved by')} <b>{t('Callisto Enterprise')}</b>
            </Text>
          </RightsdivMob>
        </Flex>
      </BkImage>
