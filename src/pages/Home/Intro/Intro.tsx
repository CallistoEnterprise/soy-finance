...
const Intro = () => {
  ...
  return (
    <Container id="home">
      ...
      <Spacer height="10px" />
      <Row>
        <Subtitle color={isEn ? Theme.colors.bgscondary : Theme.colors.primary} fw={isEn ? '700' : '400'}>
          {t('The DeFi Ecosystem')}
        </Subtitle>
        <Subtitle color={isEn ? Theme.colors.primary : Theme.colors.bgscondary} fw={isEn ? '400' : '700'}>
          {t('With a Real Emphasis on Security.')}
        </Subtitle>
      </Row>
      <Spacer height="50px" />
...
const ScrollDiv = styled.div`
  ...
  z-index: 99999;
  &:hover {
    background-color: rgba(126, 162, 36, 0.7);
  }
